...
export class LiveCasinoComponent implements OnInit  {
  ...
  id  :any
  dreamCasinoflag
  constructor(public router : Router, public ngxSpinner : NgxSpinnerService, public ac : ActivatedRoute, public sanatizer : DomSanitizer, public socketSerive : SocketService , public sanitized : DomSanitizer, public service : MatchService) {
