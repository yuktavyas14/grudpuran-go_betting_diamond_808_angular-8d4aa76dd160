...
export class SidebarComponent implements OnInit,OnDestroy {
  ...
  private socketSerive: SocketService, private service: MatchService, public router : Router,
...
//  this.pageScroll()
  ...
  ngAfterViewInit() {
    this.mtree1($ , this, this.document)
  ...
  getSeriesList() {
    ...
    this.service.getSeriesList({ is_sidebar_call : 1}).subscribe((res) => {
      if (res.status) {
        this.seriesList = res.data;
        // console.log(this.seriesList , "test")
      } else {
  ...
  getMenulist() {
    ...
    this.service.getMenuList().subscribe((res) => {
      ...
      //  console.log(this.menuList, 'menu')
        ...
        // this.mtree1($, window, document)
        // console.log("test", this.menuList, "trd")
      }
    } )
...
getCasinoSports(){
  this.service.getCasinoSport().subscribe((res)=>{
    ...
    let casinoSport:any= this.casinoSports.filter((item:any)=> item.sport_id== 'worldcasino')
    if(casinoSport.length>0){
      this.isActiveLiveCasino= casinoSport[0].is_active ==1 ? true : false
...
onLiveCasino(series:any){
   console.log(series)
  this.router.navigate(['/main/game/casino/dreamcasino'])
