...
declare var $;
@Component({
  selector: 'app-new-brino',
  templateUrl: './new-brino.component.html',
  styleUrls: ['./new-brino.component.scss']
})
export class NewBrinoComponent implements OnInit {
  debugger
 ...
 // private token = localStorage.getItem('TokenId').replace(/['"]+/g, '');
  ...
  ngOnInit(): void {
    ...
    this.url = this.sanatizer.bypassSecurityTrustResourceUrl('https://phasergm1.diamond99.xyz/?auth=' + this.token + '&origin=' + this.origin);
