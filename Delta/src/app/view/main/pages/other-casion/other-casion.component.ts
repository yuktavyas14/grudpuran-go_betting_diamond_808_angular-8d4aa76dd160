...
declare var $: any;
@Component({
  selector: 'app-other-casion',
  templateUrl: './other-casion.component.html',
  styleUrls: ['./other-casion.component.scss']
})
export class OtherCasionComponent implements OnInit {
  sportList : any;
  sportId   : any;
  gameList  : any;
