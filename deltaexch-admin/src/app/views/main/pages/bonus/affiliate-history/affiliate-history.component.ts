...
@Component({
  selector: 'app-affiliate-history',
  templateUrl: './affiliate-history.component.html',
  styleUrls: ['./affiliate-history.component.css']
})
export class AffiliateHistoryComponent implements OnInit {
...
// Sets today's date as default.
  ...
  getBonusStatementReport() {
    ...
    this.matchservice.getUserAffiliatedHistrory(payload).subscribe((res)=>{
      if(res?.status){
